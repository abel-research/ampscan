...
#        values = [0, 0, 0]
    ...
    def chooseOpenFile(self):
        self.fname = 'C:/Users/js22g12/OneDrive - University of Southampton/Documents (OneDrive)/PhD/Surrogate Modelling/sm_tsb_6Var_2.npy'
        data = np.load(self.fname).item()
